export const STORAGE_KEYS = {
  ...
  threeSoundField2GroundEqEnabledBands: "wavedance.threeSoundField2GroundEqEnabledBands",
  ...
  threeSoundField2PulseSensitivity: "wavedance.threeSoundField2PulseSensitivity",
  threeSoundField2PulseCooldown: "wavedance.threeSoundField2PulseCooldown",
  threeSoundField2SnareEnabled: "wavedance.threeSoundField2SnareEnabled",
  threeSoundField2SnareSensitivity: "wavedance.threeSoundField2SnareSensitivity",
  threeSoundField2SnareCooldown: "wavedance.threeSoundField2SnareCooldown",
  threeSoundField2MeteorEnabled: "wavedance.threeSoundField2MeteorEnabled",
  threeSoundField2MeteorSensitivity: "wavedance.threeSoundField2MeteorSensitivity",
  threeSoundField2MeteorCooldown: "wavedance.threeSoundField2MeteorCooldown",
  threeSoundField2FloatingBlocks: "wavedance.threeSoundField2FloatingBlocksEnabled",
  threeSoundField2FloatingBlockIntensity: "wavedance.threeSoundField2FloatingBlockIntensity",
  threeSoundField2FloatingBlockMinSize: "wavedance.threeSoundField2FloatingBlockMinSize",
  threeSoundField2FloatingBlockMaxSize: "wavedance.threeSoundField2FloatingBlockMaxSize",
  threeSoundField2FloatingBlockSpeed: "wavedance.threeSoundField2FloatingBlockSpeed",
  threeSoundField2FloatingBlockCount: "wavedance.threeSoundField2FloatingBlockCount",
  ...
  threeSoundField2BloomThreshold: "wavedance.threeSoundField2BloomThreshold",
  ...
  threeSoundField2CameraFov: "wavedance.threeSoundField2CameraFovDeg",
  ...
  threeSoundField2CoverHeight: "wavedance.threeSoundField2CoverHeight",
  threeSoundField2CoverOpacity: "wavedance.threeSoundField2CoverOpacity",
...
export const DISPLAY_MODES = {
  ...
  threeSoundField: "threeSoundField",
  threeSoundField2: "threeSoundField2",
...
export const DEFAULT_CONFIG = {
  ...
  threeSoundField: {
    ...
    bassRippleStrength: 70,
    bassRippleSensitivity: 55,
    meteorEnabled: true,
    meteorStrength: 60,
    meteorSensitivity: 50,
    idleWaveEnabled: true,
    idleWaveAmplitude: 18,
    idleWaveSpeed: 45,
    idleEnergyThreshold: 0.035,
    themeId: "indigo",
    colorLow: "#1a1a2e",
    colorMid: "#4a4580",
    colorHigh: "#8f7cff",
...
export function normalizeDisplayMode(mode) {
  ...
  if (s === DISPLAY_MODES.threeSoundField) return DISPLAY_MODES.threeSoundField;
...
export function windowStorageKeys(windowLabel) {
  ...
  return {
    ...
    threeSoundFieldGridPreset: `${pre}.threeSoundFieldGridPreset`,
    threeSoundFieldResponseStrength: `${pre}.threeSoundFieldResponseStrength`,
    threeSoundFieldResponseRange: `${pre}.threeSoundFieldResponseRange`,
    threeSoundFieldBassRipple: `${pre}.threeSoundFieldBassRippleEnabled`,
    threeSoundFieldBassRippleStrength: `${pre}.threeSoundFieldBassRippleStrength`,
    threeSoundFieldBassRippleSensitivity: `${pre}.threeSoundFieldBassRippleSensitivity`,
    threeSoundFieldMeteor: `${pre}.threeSoundFieldMeteorEnabled`,
    threeSoundFieldMeteorStrength: `${pre}.threeSoundFieldMeteorStrength`,
    threeSoundFieldMeteorSensitivity: `${pre}.threeSoundFieldMeteorSensitivity`,
    threeSoundFieldTheme: `${pre}.threeSoundFieldThemeId`,
    threeSoundFieldIdleWave: `${pre}.threeSoundFieldIdleWaveEnabled`,
    threeSoundFieldIdleWaveAmplitude: `${pre}.threeSoundFieldIdleWaveAmplitude`,
    threeSoundFieldIdleWaveSpeed: `${pre}.threeSoundFieldIdleWaveSpeed`,
    threeSoundFieldBloom: `${pre}.threeSoundFieldBloomEnabled`,
    threeSoundFieldBloomStrength: `${pre}.threeSoundFieldBloomStrength`,
    threeSoundFieldCameraPitch: `${pre}.threeSoundFieldCameraPitchDeg`,
    threeSoundFieldCameraDistance: `${pre}.threeSoundFieldCameraDistance`,
    threeSoundFieldAutoRotate: `${pre}.threeSoundFieldAutoRotateEnabled`,
    threeSoundFieldAutoRotateSpeed: `${pre}.threeSoundFieldAutoRotateSpeedDeg`,
    threeSoundFieldShape: `${pre}.threeSoundFieldShapeConfig`,
    threeSoundField2GridPreset: `${pre}.threeSoundField2GridPreset`,
    threeSoundField2TerrainDensity: `${pre}.threeSoundField2TerrainDensity`,
    threeSoundField2GroundEqBands: `${pre}.threeSoundField2GroundEqBands`,
    threeSoundField2GroundEqEnabledBands: `${pre}.threeSoundField2GroundEqEnabledBands`,
    threeSoundField2GroundEqMotionSpeed: `${pre}.threeSoundField2GroundEqMotionSpeed`,
    threeSoundField2GroundEqAmplitude: `${pre}.threeSoundField2GroundEqAmplitude`,
    threeSoundField2PulseEnabled: `${pre}.threeSoundField2PulseEnabled`,
    threeSoundField2PulseSensitivity: `${pre}.threeSoundField2PulseSensitivity`,
    threeSoundField2PulseCooldown: `${pre}.threeSoundField2PulseCooldown`,
    threeSoundField2SnareEnabled: `${pre}.threeSoundField2SnareEnabled`,
    threeSoundField2SnareSensitivity: `${pre}.threeSoundField2SnareSensitivity`,
    threeSoundField2SnareCooldown: `${pre}.threeSoundField2SnareCooldown`,
    threeSoundField2MeteorEnabled: `${pre}.threeSoundField2MeteorEnabled`,
    threeSoundField2MeteorSensitivity: `${pre}.threeSoundField2MeteorSensitivity`,
    threeSoundField2MeteorCooldown: `${pre}.threeSoundField2MeteorCooldown`,
    threeSoundField2FloatingBlocks: `${pre}.threeSoundField2FloatingBlocksEnabled`,
    threeSoundField2FloatingBlockIntensity: `${pre}.threeSoundField2FloatingBlockIntensity`,
    threeSoundField2FloatingBlockMinSize: `${pre}.threeSoundField2FloatingBlockMinSize`,
    threeSoundField2FloatingBlockMaxSize: `${pre}.threeSoundField2FloatingBlockMaxSize`,
    threeSoundField2FloatingBlockSpeed: `${pre}.threeSoundField2FloatingBlockSpeed`,
    threeSoundField2FloatingBlockCount: `${pre}.threeSoundField2FloatingBlockCount`,
    threeSoundField2Theme: `${pre}.threeSoundField2ThemeId`,
    threeSoundField2Bloom: `${pre}.threeSoundField2BloomEnabled`,
    threeSoundField2BloomStrength: `${pre}.threeSoundField2BloomStrength`,
    threeSoundField2BloomThreshold: `${pre}.threeSoundField2BloomThreshold`,
    threeSoundField2CameraPitch: `${pre}.threeSoundField2CameraPitchDeg`,
    threeSoundField2CameraDistance: `${pre}.threeSoundField2CameraDistance`,
    threeSoundField2CameraFov: `${pre}.threeSoundField2CameraFovDeg`,
    threeSoundField2AutoRotate: `${pre}.threeSoundField2AutoRotateEnabled`,
    threeSoundField2AutoRotateSpeed: `${pre}.threeSoundField2AutoRotateSpeedDeg`,
    threeSoundField2Cover: `${pre}.threeSoundField2CoverEnabled`,
    threeSoundField2CoverSize: `${pre}.threeSoundField2CoverSize`,
    threeSoundField2CoverHeight: `${pre}.threeSoundField2CoverHeight`,
    threeSoundField2CoverOpacity: `${pre}.threeSoundField2CoverOpacity`,
    threeSoundField2Shape: `${pre}.threeSoundField2ShapeConfig`,
